...
class _ViewMainState extends State<ViewMain> { 
  ...
  Widget _buildCustomProfil (String fullname, AssetImage logo, double logoSize,bool showNotificationIcon) {
    return Container( 
      padding : EdgeInsets.only(top: 40,bottom:15,right: 24,left: 24) , 
      child: Row ( 
    ...
    color: Colors.white,
      ...
      size: 32.0, ), ), 
              ...
              child : Column( 
                crossAxisAlignment : CrossAxisAlignment.start, 
                children : [ 
                  Container(child: Text("My Poin",style : TextStyle(fontWeight : FontWeight.bold,fontSize:12,))),
                   
                  Container(child: Text("3000", style : TextStyle(fontWeight : FontWeight.bold,fontSize:16,color : Colors. red)),), 
                ], 
              ),), 
                                    ],), 
                                  ),
      ...
      size: 32.0, ), ), 
              ...
              child : Column( 
                crossAxisAlignment : CrossAxisAlignment.start, 
                children : [ 
                  Container(child: Text("My Trip",style : TextStyle(fontWeight : FontWeight.bold,fontSize:12,))),
                   
                  Container(child: Text("0", style : TextStyle(fontWeight : FontWeight.bold,fontSize:16,color: Colors. red)),), 
                ], 
              ),), 
                                    ],), 
                                  ),
                ...
                Container ( 
                width: MediaQuery.of(context).size.width, 
                padding : EdgeInsets.only(top: 20,bottom:20,right: 24,left: 24) ,
                decoration: new BoxDecoration(
